...
export function PainelContador({
  ...
  return (
    <div>
      ...
      <Button onClick={onDiminuir} disabled={contador === 0}>
        Diminuir
      </Button>
      <Button onClick={onDiminuirSeguro} disabled={contador === 0}>
        Diminuir Seguro
      </Button>
      ...
      <CampoInput
        tipo="number"
        placeholder="Digite valor de incremento"
        onChange={onAlterarIncremento}
      />
